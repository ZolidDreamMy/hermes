$(() => {
  display_info_checkout();
});

function display_info_checkout() {
  ...
  $.getJSON(urlAPI).done(function (data) {
    ...
    $.each(data, function (k, item) {
      console.log(item);
      line += "<tr>";
      line += "<td><a href='edit_infoguest_checkout.php?id="+item.bl_id+"'><button type= 'button' class='btn btn-info btn-round'>Info</button></a></td>";
