<?php include "../function.php" ?>
                    ...
                    <div class="col-md-12">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-8 text-right">
                                    ...
                                    <button type="button" id="" class="btn btn-info btn-round"> Close</button>
                                </div>
                            </div>
                        </div>
                        <!-- form -->
                        ...
                        <form id="" action="" method="get">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <h4><i class="nc-icon nc-backpack"></i> Infomation  </h4>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="text-md-right">
                                            <h4><a href="" id="">Save</a> </h4>
                                        </div>
                                    </div>
                                </div>
                                <!--end row contact -->
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="lname_edit_infoguest" name=""  value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input type="number" class="form-control" id="phone_edit_infoguest" name=""  value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="passport_edit_infoguest"  name="" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
 ...
 <script>
     ...
     <script src=<?php echo base_url("/application/edit_info_guest.js") ?>></script>
 <!--   Core JS Files   -->
